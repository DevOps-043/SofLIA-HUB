...
export default defineConfig(function (_a) {
    ...
    var mainProcessEnvDefines = createMainProcessEnvDefines(env);
    return {
        server: {
            warmup: {
        ...
        plugins: [
            ...
            electron({
                main: {
                    ...
                    onstart: function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, startElectronDevProcess()];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                    ...
                    vite: {
                        ...
                        build: {
                            lib: {
                                entry: "electron/main.ts",
                                formats: ["cjs"],
                                fileName: function () { return "[name].js"; },
                            },
                            rollupOptions: {
