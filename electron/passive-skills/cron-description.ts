...
/**
 * Traduce una expresion cron a la frase que ve el usuario.
 *
 * Vive aqui —y no en el motor de flujos, de donde procede— porque las Skills
 * pasivas son ahora las unicas que programan cron desde la interfaz.
 */
