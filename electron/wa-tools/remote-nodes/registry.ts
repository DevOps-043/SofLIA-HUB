  ...
  },
  {
    ...
    parameters: {
      ...
      properties: {
        ...
        owner_user_id: { type: 'STRING' as const, description: 'Usuario SOFIA propietario cuando visibility=personal.' },
        organization_id: { type: 'STRING' as const, description: 'Organizacion SOFIA cuando visibility=organization.' },
        visibility: { type: 'STRING' as const, enum: ['personal', 'organization'], description: 'Alcance del nodo remoto.' },
      },
