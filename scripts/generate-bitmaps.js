...
async function renderBrandSources() {
  ...
  const headerBase = svg(150, 57, `
    ...
    <text x="12" y="25" fill="#0A2540" font-family="Inter,Segoe UI,Arial" font-size="14" font-weight="700">SofLIA Hub</text>
  ...
  const dmgBase = svg(660, 400, `
    ...
    <text x="330" y="52" text-anchor="middle" fill="#0A2540" font-family="Inter,Segoe UI,Arial" font-size="24" font-weight="700">SofLIA Hub</text>
