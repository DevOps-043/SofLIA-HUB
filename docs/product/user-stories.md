...
HU-024: la persona puede desbloquear/bloquear la bóveda con Windows, revisar una
sugerencia conservando el sitio original tras SSO y usar zoom sin alterar otra
pestaña. Puede pedir a Orbe “navegador detener tarea”, activar explícitamente
memoria de títulos/URL y continuar manualmente ante una barrera sensible.
La interfaz no permite aprobar autenticación ni saltar esa barrera desde IPC.

HU-024: ante ajustes dañados, el titular puede solicitar recuperar permisos,
privacidad o política del agente desde soporte, revisar la advertencia nativa
y cancelar sin modificar el principal. Tras recuperar debe autorizar nuevamente
lo necesario; no reaparecen concesiones antiguas. Restablecer permisos avisa que
elimina todas las copias locales de recuperación de permisos del perfil.
La persona puede recuperar atajos y revisar de nuevo sus instrucciones, o
recuperar configuración sync y volver a elegir categorías. Ninguna de esas
acciones ejecuta atajos o activa transferencia automáticamente.
