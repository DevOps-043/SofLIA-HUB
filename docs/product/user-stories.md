...
| HU-016 | Como usuario recurrente, quiero que SofLIA recuerde hechos, preferencias y procedimientos utiles sin mezclar identidades. | Turnos, resumen, busqueda, facts y skills por owner; borrar fact/skill; presupuesto de contexto. | RF-025, RF-026; BR-016 |
...
| HU-025 | Como usuario, quiero conversar con SofLIA mientras navego y retomar las acciones web que ejecuta el agente. | Hasta 500 pestañas lógicas con ocho vistas vivas y restauración LRU; hasta cuatro ventanas nativas separadas sin recarga ni perfil adicional; popups internos; dos vistas divididas o superpuestas; foco explícito para el agente; chat compacto premium con selectores de modelo/razonamiento y conversaciones, creación de chat y búsqueda sin restaurar la Sidebar, movible, minimizable o sustituible por la Orbe; el modelo visible orquesta, lee DOM, investiga en la web y navega a destinos conocidos sin Computer Use; la percepción pasiva usa imágenes acotadas, se difiere mientras el usuario interactúa y no compite con Computer Use; Gemini 3.6 Flash actúa sólo cuando hacen falta interacción visual, autenticación o fallback dinámico; compositor delgado y simétrico; barra secundaria plegable con favoritos y accesos a extensiones; sugerencias de historial relevantes en un menú superpuesto que no desplaza la página; OAuth/2FA sin falsos avisos por subframes y protocolos principales peligrosos bloqueados; navegador vivo sin fallback externo; contraseñas cifradas por origen; extensiones MV3 con permisos visibles, aprobación y reintento. | RF-039; BR-009, BR-018, BR-019 |
