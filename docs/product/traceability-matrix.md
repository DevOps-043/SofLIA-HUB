...
| Navegador integrado | BR-009, BR-018, BR-019 | RF-039 | HU-025 | DEC-001, DEC-008, DEC-013, DEC-014, LIM-007, LIM-017, LIM-018 | `electron/integrated-browser/`, `src/components/browser/` | `electron/__tests__/integrated-browser-*`, `src/__tests__/components/IntegratedBrowserPanel.test.tsx`, `BrowserReadingModePanel.test.tsx`, `BrowserWorkspaceLayout.test.tsx` |
...
| Voz, privacidad y orbe | BR-017 | RF-031, RF-032, RF-036 | HU-021, HU-022 | DEC-005 | `electron/python-runtime-service.ts`, `electron/elevenlabs-tts.ts`, `electron/orb-tts.ts`, `python/`, `src/components/orb/` | `electron/__tests__/python-*`, `voice-*`, `orb-*` |
