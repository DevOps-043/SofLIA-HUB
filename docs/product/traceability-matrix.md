...
| Automatizacion y actualizacion | BR-020, BR-021 | RF-031, RF-032, RF-032b, RF-032c, RF-033 | HU-022, HU-023 | LIM-016 | `electron/updater/`, `workspace-automation/`, `passive-skills/`, `daily-briefing/` | `electron/__tests__/updater-*`, `workspace-automation-*`, `passive-skills.test.ts`, `orb-announcements.test.ts` |
