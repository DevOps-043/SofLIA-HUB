# Auditoria de conexiones y base de datos (historica)

> Sustituida el 2026-07-21. Varias rutas cambiaron y la afirmacion de RLS por
> owner para Meeting Ops no coincide con las migraciones vigentes. Consultar
> `docs/data/data-architecture.md` y `docs/security/security-and-privacy.md`.
