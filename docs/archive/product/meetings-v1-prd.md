# PRD Tecnico Implementable (historico)

> Sustituido el 2026-07-21. No es normativo: describe la propuesta anterior a
> Meeting Live y contiene rutas planeadas que ya no corresponden a la
> implementacion. Consultar `docs/product/functional-requirements.md`,
> `docs/ux/screen-catalog-and-flows.md` y `docs/architecture/backend-electron.md`.
...
- [electron/main.ts](../../electron/main.ts): bootstrap y registro de handlers
- [electron/drive-service.ts](../../electron/drive-service.ts): busqueda, descarga y export de archivos desde Drive
- [electron/drive-handlers.ts](../../electron/drive-handlers.ts): IPC de Drive
- [electron/calendar-service.ts](../../electron/calendar-service.ts): OAuth Google y acceso a eventos
- [electron/iris-data-main.ts](../../electron/iris-data-main.ts): acceso main-process a equipos, proyectos e issues de IRIS
- [electron/proactive-service.ts](../../electron/proactive-service.ts): motor de recordatorios por polling
- [electron/memory-service.ts](../../electron/memory-service.ts): continuidad contextual
- [electron/whatsapp-agent.ts](../../electron/whatsapp-agent.ts): entrada conversacional de WhatsApp
- [electron/whatsapp-workflow-presentacion.ts](../../electron/whatsapp-workflow-presentacion.ts): ejemplo de workflow actual por WhatsApp
- [electron/preload.ts](../../electron/preload.ts): exponer namespaces IPC
- [src/services/drive-service.ts](../../src/services/drive-service.ts): wrapper renderer de Drive
...
[src/services/workspace-sources.ts](../../src/services/workspace-sources.ts) sigue siendo un stub.
...
2. Cambios minimos en [electron/whatsapp-agent.ts](../../electron/whatsapp-agent.ts)
   Solo para enrutar al adapter, no para mover logica de negocio ahi.

3. Cambios minimos en [electron/whatsapp-tools.ts](../../electron/whatsapp-tools.ts)
...
3. Ese adapter usara funciones existentes de [electron/iris-data-main.ts](../../electron/iris-data-main.ts)
...
Esto coincide con [electron/calendar-service.ts](../../electron/calendar-service.ts#L50)
