  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Top Aplicaciones</h3>
          <p className="text-xs text-secondary mt-0.5">Análisis de uso</p>
        </div>
      ...
      {topStats.length === 0 ? (
        <div className="py-12 flex flex-col items-center justify-center border border-dashed border-border rounded-2xl">
          <p className="text-sm text-secondary">Esperando datos...</p>
        </div>
      ) : (
            ...
            <div key={stat.name} className="group animate-in fade-in slide-in-from-right-2 duration-500" style={{ animationDelay: `${i * 100}ms` }}>
              <div className="flex items-center justify-between mb-1.5 px-1">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <span className="text-xs text-secondary bg-surface-2 px-1.5 py-0.5 rounded">
