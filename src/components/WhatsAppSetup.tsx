...
import type { WhatsAppSetupProps, WhatsAppStatus } from './whatsapp-setup/types';
      ...
      <div className={`flex-1 overflow-y-auto custom-scrollbar px-8 py-8 relative z-10`}>
        {!isAvailable && (
          <div className="flex flex-col items-center justify-center py-20 text-center space-y-4 bg-red-500/5 border border-red-500/10 rounded-3xl">
            ...
            <div>
              <p className="text-sm font-black text-gray-900 dark:text-white uppercase tracking-widest">Protocolo no disponible</p>
          ...
          <div className="flex flex-col items-center justify-center py-16 animate-in fade-in zoom-in-95 duration-500">
            <div className="relative mb-10">
              ...
              <div className="relative w-32 h-32 rounded-[2.5rem] bg-gray-100 dark:bg-background-dark border-2 border-accent/30 flex items-center justify-center shadow-2xl">
                <svg className="w-16 h-16 text-accent drop-shadow-[0_0_15px_rgba(34,197,94,0.3)]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between relative z-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    {status.phoneNumber && (
                      <p className="text-[10px] font-mono text-accent/70 mt-1 uppercase tracking-widest">+{status.phoneNumber}</p>
                    )}
                  </div>
                </div>
                <button
              ...
              <div className="bg-white dark:bg-white/3 border border-gray-200 dark:border-white/10 rounded-3xl p-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="px-2 py-1 bg-gray-100 dark:bg-white/5 rounded-lg">
                    <span className="text-[9px] font-mono text-gray-500 dark:text-gray-400">{status.allowedNumbers.length}</span>
                  </div>
                </div>
                ...
                <div className="flex gap-2 mb-6">
                  <div className="flex-1 relative">
                    <input
                      ...
                      placeholder="521..."
                      className="w-full pl-3 pr-4 py-2.5 bg-gray-50 dark:bg-background-dark/80 border border-gray-200 dark:border-white/10 rounded-xl text-gray-900 dark:text-white text-xs font-mono focus:outline-none focus:border-accent/30 transition-all"
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto custom-scrollbar pr-1">
                  {status.allowedNumbers.length > 0 ? (
                    status.allowedNumbers.map((num) => (
                      <div key={num} className="flex items-center justify-between px-3 py-2.5 rounded-xl bg-gray-50 dark:bg-white/2 border border-gray-100 dark:border-white/5 group/num">
                        <span className="text-[10px] text-gray-600 dark:text-gray-300 font-mono tracking-widest">+{num}</span>
                        <button
                          ...
                          <div className="space-y-1.5">
                             ...
                             <div className="flex gap-1.5">
                                ...
                                <button
                                  ...
                                  className="px-3 py-2 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl text-[10px] text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all"
                                >
                                  +
                                </button>
                             </div>
