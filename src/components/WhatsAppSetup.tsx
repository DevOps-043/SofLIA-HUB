        ...
        {isAvailable && !status.connected && !status.qr && !connecting && (
          <div className="flex flex-col items-center justify-center py-16 animate-in fade-in zoom-in-95 duration-500">
            <div className="relative mb-10">
              ...
              <div className="relative w-32 h-32 rounded-[2.5rem] bg-background-dark border-2 border-accent/30 flex items-center justify-center shadow-2xl">
          ...
          <div className="flex flex-col items-center py-10 animate-in fade-in zoom-in-95 duration-500">
            {status.qr ? (
              <div className="space-y-10 flex flex-col items-center">
                <div className="relative p-8 bg-white/5 border border-white/10 rounded-[3rem] shadow-[0_0_50px_rgba(255,255,255,0.03)] group transition-all duration-700 hover:border-accent/40">
                ...
                <div className="flex gap-2 mb-6">
                  <div className="flex-1 relative">
                    <input
                      ...
                      placeholder="521..."
                      className="w-full pl-3 pr-4 py-2.5 bg-background-dark/80 border border-white/10 rounded-xl text-white text-xs font-mono focus:outline-none focus:border-accent/30 transition-all"
