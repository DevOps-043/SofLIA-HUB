...
export function ModelMessageContent({
  ...
  return (
    <>
      <div className="w-full min-w-0 p-0 bg-transparent border-none shadow-none text-gray-800 dark:text-gray-100 text-[15px] leading-relaxed group/msg-content relative transition-all duration-300">
