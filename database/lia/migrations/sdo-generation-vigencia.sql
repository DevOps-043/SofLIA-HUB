...
+-- en el SQL Editor. NO en IRIS. Requiere database/lia/migrations/sdo-tables.sql aplicado.
--
...
+-- Mismo criterio que database/lia/migrations/sdo-tables.sql: anon key sin sesion de Supabase Auth,
